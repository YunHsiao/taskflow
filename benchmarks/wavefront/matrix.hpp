...
std::chrono::microseconds measure_time_asio(unsigned);
std::chrono::microseconds measure_time_job(unsigned);
...
std::chrono::microseconds measure_time_asio(unsigned, unsigned);
std::chrono::microseconds measure_time_job(unsigned, unsigned);
